/**
 * Constants for Port Scanner Enhanced component
 */

import type { ScanExplanation, ScanType } from './types';
...
export const SCAN_EXPLANATIONS: Record<ScanType, ScanExplanation> = {
  'tcp-connect': {
