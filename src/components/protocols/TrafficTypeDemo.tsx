      ...
      <div className="demo-container">
        ...
        <div className="network-canvas-container">
          ...
          <div className="sr-only">
            Use the buttons above to control the animation. Press Tab to navigate between traffic
            type selections and animation controls. Press Enter or Space to activate buttons.
          </div>
