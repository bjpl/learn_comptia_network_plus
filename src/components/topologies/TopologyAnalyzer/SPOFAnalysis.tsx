/**
 * SPOF Analysis component for TopologyAnalyzer
 */

import React from 'react';
import type { SPOFAnalysis as SPOFAnalysisType } from './types';

interface SPOFAnalysisProps {
  topologyName: string;
  spofData: SPOFAnalysisType[];
}

export const SPOFAnalysisComponent: React.FC<SPOFAnalysisProps> = ({ topologyName, spofData }) => {
