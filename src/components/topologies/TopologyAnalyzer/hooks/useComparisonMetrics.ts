/**
 * useComparisonMetrics Hook
 * Calculates comparison metrics for topology comparison
 */

import { useMemo } from 'react';
import type { TopologyDefinition, ComparisonMetrics } from '../../topologies-types';

export const useComparisonMetrics = (selectedTopologyData: TopologyDefinition[]): ComparisonMetrics[] => {
  return useMemo((): ComparisonMetrics[] => {
