...
interface ExamScenariosTabProps {
  selectedScenario: string | null;
  onSelectScenario: (id: string) => void;
}

export const ExamScenariosTab = React.memo<ExamScenariosTabProps>(
...
ExamScenariosTab.displayName = 'ExamScenariosTab';
