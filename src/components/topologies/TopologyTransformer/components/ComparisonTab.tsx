/**
 * Comparison matrix tab showing topology characteristics
 */

import React from 'react';
import { comparisonMatrix } from '../constants/comparisonMatrix';
  ...
  return (
    <div className="comparison-matrix-tab">
      ...
      <div className="score-legend">
        ...
        <div className="legend-item">
          <span className="color complexity"></span> <strong>Complexity:</strong> 1=Simple, 10=Complex
        </div>
      </div>
