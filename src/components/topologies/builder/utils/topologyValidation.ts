...
import type { BuilderDevice, BuilderConnection, ValidationIssue, DetectedTopologyType, CostSummary } from '../types';

/**
 * Detect the topology type based on devices and connections
 */
export function detectTopologyType(
...
/**
 * Validate the topology and return issues
 */
